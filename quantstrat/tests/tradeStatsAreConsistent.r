...
stats.eight  = tradeStats(port)

txns8       = stats.eight$Num.Txns
trades8     = stats.eight$Num.Trades
maxeq8      = stats.eight$Max.Equity
maxdraw8    = stats.eight$maxDrawdown
largwin8    = stats.eight$Largest.Winner
pfactor8    = stats.eight$Profit.Factor
...
test_that('Number of transactions is consistent', {
  ...
  expect_that(txns5, equals(161))
  expect_that(txns6, equals(11))
  expect_that(txns7, equals(27))
  expect_that(txns8, equals(161))
...
test_that('Number of the number of trades is consistent', {
  ...
  expect_that(trades5, equals(80))
  expect_that(trades6, equals(5))
  expect_that(trades7, equals(13))
  expect_that(trades8, equals(80))
...
test_that('Max drawdown is consistent', {
  ...
  expect_that(maxdraw5, equals(-56019))
  expect_that(maxdraw6, equals(-13434))
  expect_that(maxdraw7, equals(-8374))
  expect_that(maxdraw8, equals(-56019))
...
test_that('Largest winner is consistent', {
  ...
  expect_that(largwin5, equals(34054))
  expect_that(largwin6, equals(5018))
  expect_that(largwin7, equals(16265))
  expect_that(largwin8, equals(34054))
...
test_that('Profit Factor is consistent', {
  ...
  expect_that(pfactor5, equals(0.8401456))
  expect_that(pfactor6, equals(1.561851))
  expect_that(pfactor7, equals(8.801109))
  expect_that(pfactor8, equals(0.8401456))
